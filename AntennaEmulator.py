...
def main(argv):
    ...
    debugOutput = False
    compression = False
    two_ns_sampling_step = False # 2ns sampling step means 8000ps divisibility, 4ns means 16000ps divisibility

    ig.initialize_globals(test_topics, nemaTalker, incoming_schema_validation, outgoing_schema_validation, loopData, debugOutput, compression, two_ns_sampling_step)
